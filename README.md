...
The apk can be directly installed in android devices. The default dummy user sign in credentials are -> username: user1; password: password.
...
- Additional functionalities for the app:
	- Implement Google sign-in in mobile application (Included in the dev environment: accessible through expo)
